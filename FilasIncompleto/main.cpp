/*
 Nome do aluno: Marco Antonio Lopes Ribeiro

 Objetivo: Criar uma funcao para ordenar palavras em ordem alfabetica.

 Como usar: O usuario escolhe uma opcao do menu para inserir, remover ou exibir palavras.

 Resultado: As palavras sao exibidas em ordem alfabetica.
 */
